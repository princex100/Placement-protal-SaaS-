  ...
  return (
    <div className="mx-auto max-w-7xl p-4 sm:p-6 lg:p-8">
      ...
      <div className="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-2 xl:grid-cols-3">
        {drives.length === 0 ? (
          <div className="col-span-full flex h-40 flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200 dark:border-white/[0.08] bg-slate-50 dark:bg-white/[0.01]">
            <p className="text-slate-600 dark:text-neutral-500">No placement drives found.</p>
          </div>
            ...
            <div className="mb-6 flex items-start justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-slate-500 dark:text-neutral-400">{drive.role}</p>
                </div>
              </div>
              <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-slate-100 dark:bg-white/[0.04] text-slate-700 dark:text-neutral-600 transition-all group-hover:bg-indigo-500 group-hover:text-slate-900 dark:group-hover:text-white">
                <ArrowRight size={16} />
              </div>
            </div>
