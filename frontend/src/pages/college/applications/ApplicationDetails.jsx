        ...
        <div className="flex flex-col gap-6">
           <div className="rounded-2xl border border-slate-200 dark:border-white/[0.06] bg-white dark:bg-white/[0.02] backdrop-blur-xl p-6 sm:p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4 rounded-xl bg-slate-100 dark:bg-white/[0.04] border border-slate-100 dark:border-white/[0.04] p-4">
                <div>
                ...
                <div>
                  <p className="text-xs font-semibold text-slate-600 dark:text-neutral-500 uppercase">Location</p>
                  <p className="mt-1 flex items-center gap-1 font-medium text-slate-900 dark:text-white"><MapPin size={16} className="text-slate-600 dark:text-neutral-500" /> {drive?.location || "TBD"}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-slate-200 dark:border-white/[0.06] bg-white dark:bg-white/[0.02] backdrop-blur-xl p-6 sm:p-8">
            ...
            <div className="flex flex-col items-center justify-center gap-4 rounded-xl border-2 border-dashed border-slate-200 dark:border-white/[0.08] bg-slate-50 dark:bg-white/[0.01] p-8">
