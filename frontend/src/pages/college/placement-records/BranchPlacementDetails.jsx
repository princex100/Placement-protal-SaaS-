...
const BranchPlacementDetails = () => {
  ...
  return (
    <div className="mx-auto max-w-7xl p-6 lg:p-8">
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          ...
          <div className="flex items-center gap-4 rounded-2xl bg-white p-4 shadow-sm dark:bg-slate-900">
            <div className="text-center">
              <p className="text-xs font-semibold text-slate-400">Eligible</p>
              <p className="text-xl font-bold text-slate-900 dark:text-white">{record.eligibleStudents}</p>
            </div>
            <div className="h-8 w-px bg-slate-200 dark:bg-slate-800"></div>
            <div className="text-center">
              <p className="text-xs font-semibold text-slate-400">Placed</p>
              <p className="text-xl font-bold text-emerald-600 dark:text-emerald-400">{record.placedStudentsCount}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Toolbar */}
      <div className="mb-6 flex items-center justify-between rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800/60 dark:bg-slate-900">
        <div className="relative w-full max-w-md">
          ...
          <input
            ...
            className="w-full rounded-xl border-none bg-slate-50 py-2.5 pl-10 pr-4 text-sm focus:ring-2 focus:ring-blue-500 dark:bg-slate-800/50 dark:text-white"
          />
        </div>
      </div>
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800/60">
              {filteredStudents.length === 0 ? (
                <tr>
                  <td colSpan="5" className="py-8 text-center text-slate-500">No placed students found.</td>
                </tr>
              ) : (
