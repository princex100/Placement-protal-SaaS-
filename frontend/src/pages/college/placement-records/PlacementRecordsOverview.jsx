  ...
  if (loading) {
    return (
      <div className="flex h-[60vh] flex-col items-center justify-center gap-4">
        ...
        <p className="text-sm font-medium text-neutral-500">Loading placement records...</p>
      </div>
    );
  }
  ...
  return (
    <div className="mx-auto max-w-7xl p-4 sm:p-6 lg:p-8">
      <div className="mb-8 flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-white">Placement Records</h1>
      ...
      {records.length === 0 && !loading ? (
        <div className="flex flex-col items-center justify-center rounded-2xl border border-white/[0.06] bg-white/[0.02] backdrop-blur-xl p-12 text-center">
          ...
          <h3 className="mt-4 text-lg font-bold text-white">No placement records yet</h3>
          <p className="mt-2 text-sm text-neutral-400">
        ...
        <div className="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
          {records.map((record, index) => (
            ...
            >
              ...
              <h3 className="mb-4 text-xl font-bold text-white">{record.branchName}</h3>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-semibold text-white">{record.totalStudents}</span>
                </div>
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-semibold text-white">{record.eligibleStudents}</span>
                </div>
